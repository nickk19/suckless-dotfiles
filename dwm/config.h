...
static const char *fonts[]          = { "Terminess Powerline:size=10" };
...
static const char col_cyan[]        = "#00835c";  /* Active tag and window border color */
...
/* tagging */
static const char *tags[] = { "WEB", "CODE", "SYS", "IRC", "MEDIA", "EXTRA", "MISC" };
